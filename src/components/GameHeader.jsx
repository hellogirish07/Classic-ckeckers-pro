  ...
  return (
    <div className="max-w-lg w-full mb-6 mx-auto z-50">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-2 bg-neutral-800 glass-pennal px-3 py-1 rounded-full text-xs font-bold text-neutral-400">
          {gameMode === 'PvC' ? 'PLAYER VS CPU' : 'LOCAL 1v1'}
        </div>
        <div className="flex items-center gap-2">
          <button
            onClick={onShowSettings}
            className="p-2 bg-neutral-800 glass-pennal hover:bg-neutral-700 rounded-full transition-colors"
            title="Settings"
          >
            <Settings size={18} />
          </button>
